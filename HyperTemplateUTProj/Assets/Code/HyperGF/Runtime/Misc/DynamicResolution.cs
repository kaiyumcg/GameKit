...
public class DynamicResolution : MonoBehaviour
{
    bool useDRS = false;
    [Header("Android")]
    [SerializeField] bool enableInAndroid = false;
    [SerializeField] float androidMinScale = 0.6f, androidMaxScale = 0.85f;
    [Header("iOS")]
    [SerializeField] bool enableIn_iOS = false;
    [SerializeField] float iOS_MinScale = 0.6f, iOS_MaxScale = 0.85f;
    ...
    private void Awake()
    {
        ...
        MaxScaleFactor = 1.0f;
#if UNITY_ANDROID
        useDRS = enableInAndroid;
        MinScaleFactor = androidMinScale;
        MaxScaleFactor = androidMaxScale;
#elif UNITY_IOS
        useDRS = enableIn_iOS;
        MinScaleFactor = iOS_MinScale;
        MaxScaleFactor = iOS_MaxScale;
#endif
    }
    ...
    float MinScaleFactor = 0.65f;
    float MaxScaleFactor = 0.8f;
#endif
    ...
    {
        if (instance.useDRS == false) { return; }
...
#if UNITY_ANDROID
        ScalableBufferManager.ResizeBuffers(instance.MaxScaleFactor, instance.MaxScaleFactor);
#endif
